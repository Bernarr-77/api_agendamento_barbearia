...
export default function ServicesPage() {
  ...
  const filteredServices = services.filter((s) => {
    ...
    if (activeTab === 'FISIOTERAPIA') return cat === 'FISIOTERAPIA';
    if (activeTab === 'QUIROPRAXIA') return cat === 'QUIROPRAXIA';
  ...
  const tabs = [
    ...
    { id: 'QUIROPRAXIA', label: 'Quiropraxia' },
    { id: 'ESTETICO', label: 'Botox/Estética' },
  ];
