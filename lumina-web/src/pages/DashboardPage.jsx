  ...
  const categories = [
    {
      id: 'FISIOTERAPIA',
      title: 'Fisioterapia',
      description: 'Reabilitação, RPG e alívio de dores',
      icon: (
    ...
    },
    {
      ...
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
          <path d="M4 12v-2a8 8 0 1 1 16 0v2" />
    ...
    {
      id: 'ESTETICO',
      title: 'Botox & Estética',
      description: 'Tratamentos faciais e bem-estar',
      icon: (
        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
      ...
      gradient: 'linear-gradient(135deg, #FFB09C 0%, #FF7F50 100%)',
    },
  ];
